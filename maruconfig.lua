...
_G.Fruits_Settings = { -- ตั้งค่าผล
    ...
    ['Select_Fruits'] = {"Ice-Ice", "Quake-Quake", "Light-Light", "Dark-Dark", "Spider-Spider", "Rumble-Rumble", "Magma-Magma", "Buddha-Buddha"} -- กินหรือซื้อตอนไม่มีผล
}
...
-- script ở đây nha ae(key,id,script)
